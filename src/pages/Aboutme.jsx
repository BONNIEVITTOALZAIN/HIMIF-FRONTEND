  ...
  return (
    <div className="min-h-screen bg-black text-white pt-24 pb-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-red-950/40 border mb-5 border-red-900/50  drop-shadow-md">
            <Users className="w-5 h-5 text-red-500" />
            <span className="text-white font-medium text-sm tracking-wide">Tentang Kami</span>
          </div>
          <div className='flex justify-center items-center'>
            <div className='h-2 min-w-40 bg-white shadow-[0_0_20px_#ef4444] rounded-xl' />
          </div>
          <h1 className="text-5xl md:text-5xl font-black m-5  tracking-tight">
          ...
          <div className='flex justify-center items-center'>
            <div className='h-2 min-w-50 bg-red-500 shadow-[0_0_20px_#ef4444] rounded-xl' />
          </div>

          <p className="text-gray-400 text-lg md:text-xl max-w-3xl mx-auto font-light leading-relaxed mt-4">Himpunan Mahasiswa Informatika  adalah organisasi mahasiswa program studi Informatika yang khusus untuk mahasiswa program studi Informatika
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="flex flex-col items-center justify-center mb-16 mt-10"
        >
          <div className='h-1.5 w-40 bg-white drop-shadow-[0_0_10px_rgba(255,255,255,0.6)] rounded-full mb-6' />

          <div className='flex items-center justify-center gap-4 md:gap-5 mb-6 text-center'>
            <h2 className='text-5xl md:text-5xl font-black tracking-tight text-white'>
              Visi
            </h2>
            <h2 className='text-4xl md:text-5xl font-black tracking-tight text-white'>
              &
            </h2>
            <h2 className='text-5xl md:text-5xl font-black text-red-500  tracking-tight'>
              Misi
            </h2>
          </div>

          <div className='h-1.5 w-56 bg-red-500 shadow-[0_0_20px_#ef4444] rounded-full' />
        </motion.div>
        ...
        <div className='flex justify-center  items-center h-auto w-auto mb-10'>
          <p className='text-2xl font-extralight italic font-sans'>
            "Mudah-Kreatif-Berwawasan Global"
          </p>
        </div>
      </div>
      <div
